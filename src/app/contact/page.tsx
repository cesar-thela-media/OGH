      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-[15%]">
          <div className="grid md:grid-cols-2 gap-12">
            {/* Contact Info */}
            <div>
              <h2 className="text-3xl font-heading font-[700] text-dark mb-6">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-heading font-[700] text-dark mb-1">
                      Phone
                    </h3>
                    <a
                      href="tel:3617658888"
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-body">
                      Use the form below or reach us through our social channels.
                    </p>
                  </div>
                </div>
            ...
            {/* Contact Form */}
            <div className="bg-warm-bg rounded-2xl p-8 md:p-10 border border-card-border">
              <h3 className="text-2xl font-heading font-[700] text-dark mb-6">
                Send Us a Message
              </h3>
              <form className="space-y-5">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-sm font-[600] text-dark mb-1.5"
                    >
                      Name *
                    </label>
                    <input
                      ...
                      id="name"
                      required
                      className="w-full px-4 py-3 rounded-xl border border-card-border bg-white text-sm focus:outline-none focus:ring-2 focus:ring-brand-blue/30 focus:border-brand-blue transition-all"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 rounded-xl border border-card-border bg-white text-sm focus:outline-none focus:ring-2 focus:ring-brand-blue/30 focus:border-brand-blue transition-all resize-none"
