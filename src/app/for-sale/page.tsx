export default function ForSalePage() {
  ...
  const statusColors: Record<string, string> = {
    ...
    "Under Construction": "bg-blue-100 text-brand-blue",
            ...
            {properties.map((p, i) => (
              ...
              >
                <div className="h-48 bg-gray-200 relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-brand-blue/20 to-brand-cyan/20 flex items-center justify-center">
