        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-[15%]">
          ...
          >
            {properties.map((p, i) => (
              ...
              >
                <div className="h-48 bg-gradient-card-fallback relative overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#f8a500" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="mx-auto mb-2">
