        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-[15%]">
          <div className="space-y-8">
            {communities.map((c, i) => (
              <div
                key={c.name}
                className="bg-white rounded-2xl p-8 md:p-10 border border-card-border card-hover"
              >
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
                  <div>
                    ...
                    <h2 className="text-2xl md:text-3xl font-heading font-[700] text-dark">
                      {c.name}
                    </h2>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {c.features.map((f) => (
                    <span
                      key={f}
                      className="text-xs font-[600] px-3 py-1.5 rounded-full bg-brand-blue/5 text-brand-blue"
                    >
                      {f}
                    </span>
                  ))}
